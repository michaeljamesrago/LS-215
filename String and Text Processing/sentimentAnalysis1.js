...
function sentiment(text) {
  let positives = arrayWordCount(positiveWords, text);
  let negatives = arrayWordCount(negativeWords, text);
  let posWords = Object.keys(positives);
  let negWords = Object.keys(negatives);
  let posCount = posWords.length;
  let negCount = negWords.length;
  let sentiment;
...
function arrayWordCount(arr, text) {
  let result = {};
